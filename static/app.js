...
function rowSignature(t){const key=keyFor(t);return JSON.stringify([t.name,t.size,t.category,t.num_seeds,t.progress,t.amount_left,t.state,t.dlspeed,t.upspeed,t.eta,t.ratio,t._server_name,state.selected.has(key)])}
