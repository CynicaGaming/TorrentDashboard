...
# Permanent public-tree secret/hygiene scan. It deliberately targets strong
# credential signatures rather than generic words such as "token" or "password".
