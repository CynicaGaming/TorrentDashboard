...
from torrent_dashboard.ops_config import (
...
class OperationsConfigTests(unittest.TestCase):
    def base(self):
        return normalize_operations_config(normalize_config(DEFAULT_CONFIG))
    ...
    def test_defaults_and_public_secret_mask(self):
        ...
        public = public_operations_config(public_config(config))
